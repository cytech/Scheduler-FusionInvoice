...
@stop
@section('javascript')
    {!! Html::style('assets/addons/Scheduler/Assets/morris.js.so/morris.css') !!}
    {!! Html::script('assets/addons/Scheduler/Assets/raphael/raphael.min.js') !!}
    {!! Html::script('assets/addons/Scheduler/Assets/morris.js.so/morris.min.js') !!}
